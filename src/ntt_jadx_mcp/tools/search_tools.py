"""
NTT JADX MCP - Code Search Tools
...
async def search_classes_by_keyword(
    ...
    Args:
        ...
        search_in (optional): Comma-separated list of scopes: class,method,field,code,comment.
    ...
    Description: Advanced search that supports package filtering and scope selection.
    """
